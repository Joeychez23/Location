    ...
    if ('geolocation' in navigator) {
        ...
        navigator.geolocation.getCurrentPosition(async position => {
            try {
                ...
                const api_response = await fetch('/api_key');
                ...
                //document.getElementById('weather').setAttribute("style", "text-transform: lowercase");
                ...
                //document.getElementById("issMap").style.height = "240px";
            ...
            //catch error of no value found from API   
            } catch(error) {
                document.getElementById('cityName').textContent = city_name;
                document.getElementById('weather').textContent = weather;
                document.getElementById('temp').textContent = temp;
